    ...
    async run(client, message, args) {
        ...
        if(!args.join(' ')) {
            return message.channel.send(new Discord.RichEmbed()
                ...
                .setDescription("Uso correto: !voto <emoji || numero> <mensagem> \nEx. !voto emoji Excluir o chat de visitantes")
                .setFooter(
                    '2019 © He4rt Developers',
                    'https://heartdevs.com/wp-content/uploads/2018/12/logo.png'
                )
        ...
        if(args[0] != "emoji" && args[0] != "numero") {
            return message.channel.send(new Discord.RichEmbed()
                .setTitle("Uso incorreto! Você deve informar 'emoji' ou 'numero'")
                .setDescription("Uso correto: !voto <emoji || numero> <mensagem> \nEx. !voto emoji Excluir o chat de visitantes")
                .setFooter(
                    '2019 © He4rt Developers',
                    'https://heartdevs.com/wp-content/uploads/2018/12/logo.png'
        ...
        message.channel.send(new Discord.RichEmbed()
            .setTitle(":call_me_hand::skin-tone-2: Nova votação! :call_me_hand::skin-tone-2:")
            .setDescription(text)
            .setFooter(
