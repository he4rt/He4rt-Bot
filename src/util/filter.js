...
module.exports = {
  async filterChat(client, message) {
    /**
     * @param {*} time Recebe a pre cfg de ../../assets/filterCfg { timeUrls }
     *  opcoes timeUrls.allow e timeUrls.def
     */
    ...
    if (message.content.match(regexBlock)) {
      ...
      // default kick ban futuramente integra ao DB para ver se o cliente ja possui ocorrencias
